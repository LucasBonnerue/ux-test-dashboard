...
describe("SuccessRateTracker", () => {
  ...
  describe("analyzeSuccessTrends", () => {
    it("sollte Trends für Erfolgsraten berechnen", () => {
      // Mock für analyzeSuccessTrends, um die Implementation direkt zu simulieren
      jest.spyOn(tracker, "analyzeSuccessTrends").mockImplementation((days) => {
        return {
          overallSuccessRate: 75,
          totalTests: 2,
          testSuccessRates: [
    ...
    it('sollte "unknown" zurückgeben, wenn nicht genügend Daten vorliegen', () => {
      // Mock für analyzeSuccessTrends mit zu wenigen Daten
      jest.spyOn(tracker, "analyzeSuccessTrends").mockImplementation((days) => {
        return {
          overallSuccessRate: 75,
          totalTests: 2,
      ...
      // Trend sollte "unknown" sein, da nicht genügend Daten vorhanden sind
